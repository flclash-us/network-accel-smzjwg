...
wget -O lcp.sh https://raw.githubusercontent.com/flclash-us/vps-guide-smzjwg/main/lcp.sh
chmod +x lcp.sh
bash lcp.sh install
lcp start
...
wget -O tcp_optimize.sh https://raw.githubusercontent.com/flclash-us/vps-guide-smzjwg/main/tcp_optimize.sh
